    ...
    $scope.searchCity = function() {
        ...
        $http.jsonp(weatherUrl)
            .then(function(response, status) {
                ...
                // if (response.data.cod == "404" || response.data.message == "Error: Not found city" || response.data == null) {
                //     alert("No City Found!");
               ...
               // }
                ...
                } else if ($scope.id >= 800 && $scope.id <= 899) {
                ...
                } else if ($scope.oneId >= 800 && $scope.oneId <= 899) {
                ...
                } else if ($scope.idTwo >= 800 && $scope.idTwo <= 899) {
                ...
                } else if ($scope.idThree >= 800 && $scope.idThree <= 899) {
            ...
            .catch(function(fallback){
                alert("The entered city could not be found!!!\nPlease enter a valid city. ");
                $scope.city = null;
            });
